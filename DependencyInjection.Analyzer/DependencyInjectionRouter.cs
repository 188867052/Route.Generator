...
{
    public class DependencyInjectionRouter : IRouter
    {
        private readonly IRouter defaultRouter;
        private readonly string routePath;

        public DependencyInjectionRouter(IRouter defaultRouter, string routePath)
        {
        ...
        public async Task RouteAsync(RouteContext context)
        {
            if (context.HttpContext.Request.Path == this.routePath)
            {
                ...
                routeData.Values["action"] = "ShowAllServices";
