namespace Microsoft.AspNetCore.Mvc.DataAnnotations
{
    ...
    internal sealed class DataAnnotationsModelValidatorProvider : IMetadataBasedModelValidatorProvider
    {
            ...
            IStringLocalizerFactory stringLocalizerFactory)
        {
            ...
            this._validationAttributeAdapterProvider = validationAttributeAdapterProvider;
        ...
        public void CreateValidators(ModelValidatorProviderContext context)
        {
            ...
            if (this._stringLocalizerFactory != null && this._options.Value.DataAnnotationLocalizerProvider != null)
            {
                stringLocalizer = this._options.Value.DataAnnotationLocalizerProvider(
                    context.ModelMetadata.ContainerType ?? context.ModelMetadata.ModelType,
                    this._stringLocalizerFactory);
            }
            ...
            for (var i = 0; i < context.Results.Count; i++)
            {
                ...
                var validator = new DataAnnotationsModelValidator(
                    this._validationAttributeAdapterProvider,
                    attribute,
                    stringLocalizer);
