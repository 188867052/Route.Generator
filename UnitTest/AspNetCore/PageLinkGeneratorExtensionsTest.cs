namespace UnitTest
{
    ...
    public class PageLinkGeneratorExtensionsTest
    {
        ...
        public void GetPathByPage_WithHttpContext_PromotesAmbientValues()
        {
            ...
            var linkGenerator = this.CreateLinkGenerator(endpoint1, endpoint2);

            var httpContext = this.CreateHttpContext(new { page = "/About", id = 17, });
        ...
        public void GetPathByPage_WithHttpContext_WithPathBaseAndFragment()
        {
            ...
            var httpContext = this.CreateHttpContext(new { page = "/Admin/ManageUsers", handler = "DeleteUser", });
            httpContext.Request.PathBase = new PathString("/Foo/Bar?encodeme?");
        ...
        public void GetUriByPage_WithHttpContext_WithPathBaseAndFragment()
        {
            ...
            var httpContext = this.CreateHttpContext(new { page = "/Admin/ManageUsers", });
        ...
        {
            var services = this.CreateServices(endpoints);
