namespace Microsoft.AspNetCore.Mvc.Routing
{
    ...
    public class UrlHelperBaseTest
    {
            ...
            string expected)
        {
            ...
            // Act
            AppendPathAndFragment(builder, httpContext.Request.PathBase, virtualPath, string.Empty);
            ...
            string expected)
        {
            ...
            // Act
            AppendPathAndFragment(builder, httpContext.Request.PathBase, virtualPath, fragmentValue);
