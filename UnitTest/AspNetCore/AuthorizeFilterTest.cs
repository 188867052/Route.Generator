namespace UnitTest.AspNetCore
{
    ...
    public class AuthorizeFilterTest
    {
        ...
        {
            var authorizationContext = this.GetAuthorizationContext();
        ...
        {
            // Arrange
            var authorizationContext = this.GetAuthorizationContext(anonymous: true);
        ...
        private class TestPolicyProvider : IAuthorizationPolicyProvider
        {
            ...
            public Task<AuthorizationPolicy> GetDefaultPolicyAsync()
                => Task.FromResult(this._true);

            public Task<AuthorizationPolicy> GetPolicyAsync(string policyName)
            {
                this.GetPolicyCalls++;
                return Task.FromResult(policyName == "true" ? this._true : this._false);
            }
        ...
        public async Task AuthorizationFilterCombinesMultipleFiltersWithPolicyProvider()
        {
            ...
            var authorizationContext = this.GetAuthorizationContext(anonymous: false, registerServices: s => s.Configure<MvcOptions>(o => o.AllowCombiningAuthorizeFilters = true));
