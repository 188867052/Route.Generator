namespace Microsoft.AspNetCore.Mvc.Routing
{
    ...
    public abstract class UrlHelperTestBase
    {
        ...
        {
            // Arrange
            var urlHelper = this.CreateUrlHelper(appRoot);
        ...
        {
            // Arrange
            var helper = this.CreateUrlHelper();
        ...
        {
            // Arrange
            var helper = this.CreateUrlHelper(appRoot: string.Empty, host: "www.mysite.com", protocol: null);
        ...
        {
            // Arrange
            var urlHelper = this.CreateUrlHelperWithDefaultRoutes();
        ...
        {
            // Arrange
            var expectedUrlHelper = this.CreateUrlHelper();
            ...
            var actionContext = this.CreateActionContext(httpContext.Object);
        ...
        {
            return this.CreateUrlHelper(appRoot, host: null, protocol: null);
        }

        private IUrlHelper CreateUrlHelperWithDefaultRoutes()
        {
            return this.CreateUrlHelperWithDefaultRoutes(appRoot: "/app", host: null, protocol: null);
        }
    }
}
